                    ...
                    <div class="card-body">
                        <form action="{{ route('blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" style="padding-bottom:36px;" class="form-control" name="image">
                            </div>
                            ...
                            <button type="reset" class="btn btn-md btn-warning"><i class="fas fa-redo-alt text-white"> Reset</i></button>
                             <a href="{{ route('blog.index') }}" class="btn btn-md btn-success"><i class="fas fa-backspace"> Kembali</i></a>
                        </form> 
                    </div>
                </div>
            </div>
